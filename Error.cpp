...
namespace Error {
	...
	ERROR errors[ERROR_MAX_ENTRY] = {
		...
		ERROR_ENTRY(200, "Эту операцию нельзя применить к операндам этих типов"),
		...
		ERROR_ENTRY(206, "Возвращаются данные отличного от указанного в объявлении типа"),
		...
		ERROR_ENTRY(602, "Ошибка в операторе"),
